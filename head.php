    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav mx-5">
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <li class="nav-item ">
          <a class="nav-link edit" href="website.php">&nbsp&nbspHome&nbsp&nbsp</a>
        </li>&nbsp&nbsp
        <li class="nav-item ">
        ...
        <li class="nav-item ">
          <a class="nav-link edit" href="my_appoint.php">&nbsp&nbspApponitments&nbsp&nbsp</a>
        </li> &nbsp&nbsp
         <li class="nav-item ">
          <a class="nav-link edit" href="index.php">&nbsp&nbspLog out&nbsp&nbsp</a>
        </li> &nbsp&nbsp
