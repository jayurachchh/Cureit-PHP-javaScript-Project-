...
<body>
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-8">
        <h2><a href="page1.php"><i class='fas fa-angle-left' style='font-size:36px; color: #e12454;'></i></a></h2>
        ...
        ?>
            <div class="col-lg-4 ">
              <div class="card mb-3 m" style=" min-height:280px;">
                ...
                <div class="col-12"><p class="offset-4"><a href="calander.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary" type="button" style="border-radius: 10px;"><i class="fas fa-video"> </i>
                      Video Consultancy</button></p></a></div>
                </div>
              </div>
            </div>
