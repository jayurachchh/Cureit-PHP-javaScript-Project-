...
$result1=mysqli_query($con,"select * from user where email like '$email'");
...
$surl="https://cureit.000webhostapp.com/success/index.php?email=".urlencode($email)."&did=".urlencode($did)."&Date=".urlencode($Date)."&Time=".urlencode($Time)."&Type=".urlencode($Type);
$furl="https://cureit.000webhostapp.com/success/cancel.php?email=".urlencode($email)."&did=".urlencode($did)."&Date=".urlencode($Date)."&Time=".urlencode($Time)."&Type=".urlencode($Type);
...
<td>First Name: </td>
<td><input type="text"name="firstname" id="firstname" value="<?php echo $name;?>" /></td>
</tr>
<tr>
<td>Email: </td>
