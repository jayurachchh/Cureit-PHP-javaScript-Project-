<?php
session_start();
$email1=$_SESSION['docemail'];
$con=mysqli_connect("localhost","root","");
$db=mysqli_select_db($con,"cureit");
$result=mysqli_query($con,"Select * from doctor where email='$email1'");
...
<span style="font-size:30px;cursor:pointer; color: #f7403b;" class="nav2"  >&#9776; Profile</span>
	...
	<div class="profile">
		...
		<p style><?php echo $username;?> <span>MBBS</span></p>
	</div>
</div>
...
<form action="#" method="get" >
    ...
    <div class="label"> EmailAddress:   </div> <input type="text"  disabled="true"value=<?php echo $email ?> name="email"  style="border-radius:5px; margin-left:120px; background-color:white">

<!--     <div class="label"> EmailAddress:  </div>  
    <input type="text" value=<?php echo $email?> name="email" hidden style="border-radius:5px; margin-left:120px;"> -->
