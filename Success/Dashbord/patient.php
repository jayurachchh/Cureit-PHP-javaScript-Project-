...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:30px;cursor:pointer; color:  #f7403b;;" class="nav"  >&#9776; Patient Details</span>
<span style="font-size:30px;cursor:pointer; color: #f7403b;" class="nav2"  >&#9776; Patient Details</span>
</div>
...
$data=mysqli_query($con,"SELECT p_name,p_number,p_email,date,time,type FROM appointment where doc_name like '$docname'");
echo "<table border='1'>
<tr>
<th>Patient_name</th>
