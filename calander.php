            ...
            <div class="col-lg-10">
                <div class="card border-0">
                        ...
                        <div >
                            ...
                            <div class="container">
                       <a href="extra.php?id=<?php echo $id;?>"<button  class="rounded-pill btn offset-5" id="pid" style="width:180px">Pay&nbsp;<?php echo $charges;?></a></button>
                            </div>
            ...
            document.getElementById("pid").addEventListener("click",()=>{
                for(let i=0;i<cells.length;i++)
                {
                    if(cells[i].classList.contains("select"))
                    {
                        ...
                        document.cookie="Time="+document.querySelector(".select").innerText; "expires=Thu,17 March 2022 23:59:59 GMT";
